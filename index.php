...
<div class="loader" id="page-loader"> 
  <div class="loading-wrapper">
    ...
    <div class="side-menu-name">
      Jérémy <strong>Alluin</strong>
    </div>

    <p class="side-menu-job">Développeur Front-end</p>
        ...
        <div class="timeline-bg">
          ...
          <section class="timeline profile-infos">
            ...
            <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content">
                  <h3 class="section-item-title-1">Nom Complet</h3>
                  <p>Jérémy Alluin</p>
                </div>
              </div>
            ...
            <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content">
                  <h3 class="section-item-title-1">Né le :</h3>
                  <p>18 Avril 1986, Pabu (oui, Pabu)</p>
                </div>
              </div>
              <div class="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs"></div>
            </div>
            ...
            <!-- <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content">
                  <h3 class="section-item-title-1">Retrouvez moi sur :</h3>
          ...
          <section class="timeline education" id="formation">
            ...
            <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content line-content-education">
                  <h3 class="section-item-title-1">Formation Intégrateur web</h3>
                  <h4 class="graduation-time"><i class="fa fa-university"></i> Buroscope - Rennes (35) - <span class="graduation-date">Diplômé en Juin 2011</span></h4>
                  <div class="graduation-description">
                    <p>Durant un an j'ai découvert les différents métiers du web, me permettant de me diriger vers l'intégration et la conception.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs"></div>
          ...
          <section class="timeline work-experience" id="pro">
          ...
          <section class="timeline skills" id="skills">
            ...
            <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content">
                  <h3 class="section-item-title-1">Code / Technos</h3>
                  <ul class="skills-list">
                    <li>
                      <div class="progress">
                        <div class="progress-bar" data-percent="90%" role="progressbar" style="width: 90%;">
          ...
          <section class="timeline" id="interets">
            ...
            <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content">
                  <h3 class="section-item-title-1">Street Art</h3>
                  <p>J'ai tenu un temps un site de street art "Stenskills" soutenu par l'artiste Jeff Aérosol. Je pratique également le pochoir</p>
                </div>
              </div>
              <div class="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs"></div>
            </div>
            ...
            <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content">
                  <h3 class="section-item-title-1">Bricolage</h3>
                  <p>J'utilise mon passé de menuisier pour faire des meubles en palette (ou autre) et trouver des solutions pour me faciliter la vie au quotidien.</p>
                </div>
              </div>
              <div class="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs"></div>
            </div>
            ...
            <div class="line row">
              ...
              <div class="col-md-8 content-wrap bg1">
                <div class="line-content">
                  <h3 class="section-item-title-1">bande dessinée </h3>
                  <p>J'ai une collection de "bd" qui commence à prendre de la place. J'ai été bénévole au montage des expositions au festival de bande dessinée de Saint-Malo pendant 11 ans.</p>
                </div>
              </div>
              <div class="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs"></div>
            </div>
